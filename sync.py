...
DEFAULT_ATTENDANCE_ID = "replace-this-line-with-your-attendance-id"
...
def skiller_whale_sync():
    ...
    if not attendance_id or attendance_id == DEFAULT_ATTENDANCE_ID:
        print("No attendance ID found. Please put your attendance ID in the "
              "'attendance_id' file in the current directory.")
        sys.exit(1)
